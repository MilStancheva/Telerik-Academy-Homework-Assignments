...
namespace BuildComponent1
{
    ...
    public class BuildComponent1Component : BuildComponentCore
    {
        ...
        [BuildComponentExport("BuildComponent1", IsVisible = true, IsConfigurable = true,
          Version = AssemblyInfo.ProductVersion, Copyright = AssemblyInfo.Copyright,
          Description = "BuildComponent1 build component")]
        public sealed class Factory : BuildComponentFactory
        {
            ...
            {
                return new BuildComponent1Component(base.BuildAssembler);
            }
...
<itemTwo value=""Test #2"" />";
        ...
        protected BuildComponent1Component(BuildAssemblerCore buildAssembler) : base(buildAssembler)
        {
        }
        #endregion
        ...
        public override void Apply(XmlDocument document, string key)
        {
            ...
            base.WriteMessage(MessageLevel.Diagnostic, "In BuildComponent1Component Apply() method");
        }
        #endregion
    }
}
